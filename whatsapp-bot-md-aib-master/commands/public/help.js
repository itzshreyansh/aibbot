...
📛 *${prefix}rank*
  - _Know your message count & rank in all AIB groups!_
  
📛 *${prefix}ranks*
  - _Know ranks list of AIB groups!_

📛 *${prefix}totalg*
  - _Know your message stats in all AIB groups!_
...
📛 *${prefix}steal*
  - _Change sticker name to AIB BOT!_
...
📛 *${prefix}donation*
  - _Get donation details and help AIB community!_
